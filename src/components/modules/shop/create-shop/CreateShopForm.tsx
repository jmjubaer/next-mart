...
import { createShopSchema } from "./creatShopValidation";
...
const CreateShopForm = () => {
    ...
    const handleCreateShop: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            ...
            fromData.append("data", JSON.stringify(modifyData));
            fromData.append("logo", imageFiles[0]);
            const res = await createShop(fromData);
            console.log(res);
            if (res?.success) {
    ...
    return (
        <div className='border-2 border-gray-300 rounded-xl flex-grow max-w-2xl p-5 my-5'>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleCreateShop)}>
